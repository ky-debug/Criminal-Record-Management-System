<html>
	...
	<body>
		...
		<ul>
			<li id="titlehead"><p id="title"style="font-size:35px;" href="home.php">CRIMINAL RECORD MANAGEMENT SYSTEM</p></li>
		...
		<div class="container">
			<form action="officer_login_action.php" method = "get">
				...
				<div class="row">
					<input type="submit" style="margin-right:650px; margin-top:10px;" value="Submit">
				</div>
			</form>
		</div>
		</div>
