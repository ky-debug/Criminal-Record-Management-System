<html>
  ...
  background-size: cover;
	...
	<body>
		...
		<h2 style="font-style:italic; font-size:30px;padding-left:30px;">Search for Officer Record</h2>
		
            
		
		<div class="container">
			<form action="officer_search_action.php" method = "get">
				<div class="row">
					<div class="col-25">
						<label for="fname">Officer Id</label>
					</div>
					<div class="col-75">
						<input type="text" pattern=".{1,}" required name="officersearchid" placeholder="Enter officer Id..">
					</div>
				</div>
