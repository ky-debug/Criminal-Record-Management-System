...
<body>
    ...
    <?php
        ...
        $sql = "CALL `searchbycrime`($crimeid)";
		...
		if ($result->num_rows > 0) {
			...
			while($row = $result->fetch_assoc()) {
				...
				echo "<tr><td>Crime id : </td><td>".$row['crime_id']."</td></tr>";
				echo "<tr><td>Crime name : </td><td>".$row['crime_name']."</td></tr>";
			...
			echo "<divs id='card'><p>Record not Exist</p><form action='crime_search.php' method='get'><button type='submit' id='done'>Done</button></form></div>";
