<html>
	...
	<body>
		...
		<ul>
			<li id="titlehead"style="text-decoration: underline;text-decoration-color:White;"><p id="title" style="font-size:30px;";>case Info</p></li>
		...
		<div class="container">
			<form action="add_case_record_action.php" method = "get">
				...
				<div class="row">
					...
					<div class="col-75">
						<input type="text" pattern=".{1,}" required name="caseid" placeholder="Enter case Id...">
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-75">
						<input type="text" pattern=".{1,}" required name="criminalid" placeholder="criminal id">
					</div>
				</div>
                <div class="row">
					<div class="col-25">
					...
					<div class="col-75">
						<input type="text" pattern=".{1,}" required name="crimeid" placeholder="Enter crime Id...">
					</div>
				</div>
                <div class="row">
					<div class="col-25">
