	...
	<body>
		...
		<ul>
			...
			<li id="titlehead" style="font-style:italic; text-decoration: underline;text-decoration-color:white;">
                    <a href="officer_login.php">Log Out</a>
                </li>
		...
		<div class="grid-container">
			...
			<div ><button type="button" class="btn" onclick="location.href='add_criminal_record.php'"style="background-color:transparent;">Add Criminal Details</button></div>
            <div style="text-align:right;"> <img src="imgs/searchmini.png">  </div>
            <div ><button type="button" class="btn" onclick="location.href='search_homeuser.php'"style="background-color:transparent;color:white;">Search Records</button></div>
