<html>
	...
	<body>
		...
		<h2 style="font-style:italic; font-size:30px;padding-left:30px;">Search cell Record</h2>
		
		<div style="text-align:center;"> <img src="imgs/cell1.jpg">  </div>
		
		<div class="container">
			<form action="cell_search_action.php" method = "get">
				<div class="row">
					<div class="col-25">
						<label for="fname">cell Record Id</label>
					</div>
					<div class="col-75">
						<input type="text" pattern=".{1,}" required  name="cellid" placeholder="Record Id..">
					</div>
				</div>
