<html>
	...
	<body>
		...
		<h2 style="font-style:italic; font-size:30px;padding-left:30px;">Search for Criminal Record</h2>
		
		<div style="text-align:center;"> <img src="imgs\criminal1.jpg">  </div>
		
		<div class="container">
			<form action="criminal_search_action.php" method = "get">
				<div class="row">
					<div class="col-25">
						<label for="fname">Criminial Record Id</label>
					</div>
					<div class="col-75">
