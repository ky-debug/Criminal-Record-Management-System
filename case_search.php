<html>
	...
	<body>
		...
		<h2 style="font-style:italic; font-size:30px;padding-left:30px;">Search by Case Record</h2>
		
		<div style="text-align:center;"> <img src="imgs\criminalimg.png">  </div>
		
		<div class="container">
			<form action="case_search_action.php" method = "get">
				<div class="row">
					<div class="col-25">
						<label for="fname">Case Id</label>
					</div>
					<div class="col-75">
						<input type="text" pattern=".{1,}" required  name="caserecordid" placeholder="Enter case Id..">
					</div>
				</div>
